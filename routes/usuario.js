...
router.get('/listausuarios', Login.obrigatorio, cors(), usuariosControllers.GetAllUsuarios)
...
router.options('/EnviarEmail', bodyParser.json(),cors())
router.post('/EnviarEmail', cors(), usuariosControllers.EnviarEmail);
